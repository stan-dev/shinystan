...
tooltip_ids <- c("download_multiview", 
                 ...
                 "tex_options", 
                 "diagnostic_param_transform", "dens_transform_x", "hist_transform_x", "bivariate_transform_x", "trivariate_transform_x", 
