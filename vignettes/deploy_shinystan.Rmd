...
After signing up for a ShinyApps account, follow the instructions for setting up your account on your local system using the `setAccountInfo` function in the `rsconnect` package. If you don't have the `rsconnect` package installed you can install it by running 
