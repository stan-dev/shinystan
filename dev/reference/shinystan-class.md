...
[`eight_schools`](https://mc-stan.org/shinystan/dev/reference/launch_shinystan_demo.md)
...
[`shinystan-metadata`](https://mc-stan.org/shinystan/dev/reference/shinystan-metadata.md)
