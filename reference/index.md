...
- [`shinystan-package`](https://mc-stan.org/shinystan/reference/shinystan-package.md)
  :
...
- [`launch_shinystan_demo()`](https://mc-stan.org/shinystan/reference/launch_shinystan_demo.md)
  : 'ShinyStan' demo
...
- [`as.shinystan()`](https://mc-stan.org/shinystan/reference/as.shinystan.md)
  [`is.shinystan()`](https://mc-stan.org/shinystan/reference/as.shinystan.md)
  :

  Create and test `shinystan` objects

- [`shinystan-class`](https://mc-stan.org/shinystan/reference/shinystan-class.md)
  [`shinystan`](https://mc-stan.org/shinystan/reference/shinystan-class.md)
  :

  S4 `shinystan` objects

- [`sso_info()`](https://mc-stan.org/shinystan/reference/shinystan-metadata.md)
  [`model_code()`](https://mc-stan.org/shinystan/reference/shinystan-metadata.md)
  [`notes()`](https://mc-stan.org/shinystan/reference/shinystan-metadata.md)
  [`model_name()`](https://mc-stan.org/shinystan/reference/shinystan-metadata.md)
  :

  View or change metadata associated with a `shinystan` object

- [`retrieve()`](https://mc-stan.org/shinystan/reference/retrieve.md) :
...
- [`update_sso()`](https://mc-stan.org/shinystan/reference/update_sso.md)
...
- [`deploy_shinystan()`](https://mc-stan.org/shinystan/reference/deploy_shinystan.md)
